public class StackTests {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("LL tests passed, next Stack tests");
        ...
        // case 12: testing push, peek and pop
        {
           ...
           // System.out.println(ll.size());
            ...
            while ( ll.peek() != null ) {
                ...
                System.out.println(val + " == " + (3-counter));
                assert val == 3-counter : "Error in Stack implementation!";
                counter++;
            }
        }

        // case 13: testing for constant pop and push operations
        {

            System.out.println( "If your code hangs on this test, pop and push (probably) aren't constant time!" );
            ...
            while ( ll.peek() != null ) {
                int val = ll.pop() ;
                assert val == 999999- counter : "Error in Stack implementation!";
                counter++;
            }
        }
